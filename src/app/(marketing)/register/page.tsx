  ...
  return (
    <main id="contenu" className="container-x flex flex-1 items-center justify-center py-20">
      <Card variant="elevated" className="w-full max-w-md p-8 text-center">
        ...
        <h1 className="h2 mt-2">Créer un compte</h1>
        <p className="mt-3 text-sm text-text-secondary">La création de compte et l&apos;espace formateur arrivent à la phase 2 (authentification et rôles).</p>
