  ...
  return (
    <html lang="fr" suppressHydrationWarning>
      <body className="arena-bg">
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-50 focus:rounded-lg focus:bg-primary-solid focus:px-4 focus:py-2 focus:text-primary-ink"
        >
          Aller au contenu
        </a>
        {children}
